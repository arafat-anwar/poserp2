...
<section class="content">
        ...
        {{--@if($is_woocommerce)
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control input-height" id="default_selling_price" name="default_selling_price" value="">
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-default btn-flat btn-modal custom-search-btn"  title="@lang('unit.add_unit')" ><i class="fa fa-search text-primary fa-lg"></i></button>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3" >
                <div class="form-group">
                    <br>
                    <label>
                        {!! Form::checkbox('not_for_selling', 1, false, ['class' => '', 'id' => 'not_for_selling']); !!} <strong>@lang('lang_v1.not_for_selling')</strong>
                    </label>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="">
                    @can('product.create')
                    <a class="btn btn-primary  btn-sm pull-right" href="{{action('ProductController@create')}}">
    ...
    <div class="row mt-6">
        <div class="col-md-12">
           @component('v2.components.widget')
           <!-- Custom Tabs -->
           <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active nav-item">
                    <a href="#product_list_tab" data-toggle="tab" aria-expanded="true" class="nav-link">
                        <span class="nav-icon"><i class="fa fa-cubes" aria-hidden="true"></i></span>
                        <span class="nav-text">@lang('lang_v1.all_products')</span></a>
                    </li>
                    @can('stock_report.view')
                    <li class="nav-item">
                        <a href="#product_stock_report" data-toggle="tab" class="nav-link" aria-expanded="true">
                            <span class="nav-icon"><i class="fa fa-hourglass-half" aria-hidden="true"></i></span>
