<script src="{{ asset('mbm/js/app.js') }}"></script>
<script src="{{asset('mbm/assets/js/all.js')}}"></script>
<!-- jQuery Confirm alert -->
<script src="{{asset('mbm/assets/js/jquery-confirm/jquery-confirm.min.js')}}"></script>

<!-- toastr alert -->
<script src="{{asset('mbm/notification_assets/js/toastr.min.js')}}"></script>
<!-- sweet alert -->
<script src="{{asset('mbm/notification_assets/js/sweetalert.min.js')}}"></script>
<script src="{{asset('mbm/plugins/summernote/summernote.min.js')}}"></script>
...
<script>
    ...
    let afterLoader = '<div class="loading-select left"><img src="{{ asset('mbm/images/loader.gif')}}" /></div>';
</script>
<!-- Custom JavaScript -->
@stack('js')
@toastr_render
...
<script src="{{ asset('mbm/assets/js/custom.js') }}"></script>
<script src="{{ asset('mbm/js/custom.js') }}"></script>
...
<!-- Datetime picker -->
<script src="{{asset('mbm/plugins/air-datepicker/js/datepicker.min.js')}}"></script>
