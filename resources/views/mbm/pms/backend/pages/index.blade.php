@extends('mbm.pms.backend.layouts.master-layout')
                    ...
                    <div class="row pr-4">
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item text-center">@lang('business.tax')</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $.each($('.list-group-item'), function(index, val) {
            var menu = $(this);
            $(this).click(function(event) {
                $('.list-group-item').removeClass('active');
                menu.addClass('active');
                $('.pos-tab-content').removeClass('active');
                $('.pos-tab-content').eq(menu.index()).addClass('active');
            });
        });
    });
</script>
